...
import { Wrench, Search, Plus, Edit2, Trash2, ChevronRight } from 'lucide-react'
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="flex items-center gap-4">
              ...
              <Link href="/admin/users" className="flex items-center gap-1 text-sm text-primary font-medium">
                Users
              </Link>
            </nav>
          </div>
